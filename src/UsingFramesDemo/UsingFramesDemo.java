...
// Изображение для пиктограммы метки:
        ImageIcon img=new ImageIcon("C:/Users/SAMSON/Desktop/Microsoft Word - Melon.jpg");
...
// Изображение для пиктограммы окна:
        Image icon=frame.getToolkit().getImage("C:/Users/SAMSON/Desktop/Angry customer.png");
